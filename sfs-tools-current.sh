...
#*****************************
    echo
    echo "You have decided to build 'tools' for sfs (Slackware Baseos)."
    echo
    echo "You are at the end of paragraph 4.4 of LFS-9 book"
    echo
...
#*****************************
    ...
    cp -v $RDIR/ap/lzip/lzip-$LZIPVER.tar.gz $SRCDIR || exit 1
    cd $RDIR/d/m4
...
binutils_build_sp1 () {
#*****************************
    tar xvf binutils-$BINUVER.tar.xz && cd binutils-$BINUVER
...
gawk_build () {
#*****************************
    tar xvf gawk-$GAWKVER.tar.xz && cd gawk-$GAWKVER
...
lzip_build () {
#*****************************
    tar xvf lzip-$LZIPVER.tar.gz && cd lzip-$LZIPVER
...
#*****************************
    ...
    make || exit 1
    cd src && mv -v tar tar-1.32
    cp -v tar-1.32 /tools/bin/tar-1.32 || exit 1
    cd ../..
    rm -rf tar-1.32
	echo tar-1.32 >> $SFS/tools/etc/tools_version
}
...
test_to_go
cd $SRCDIR
echo "binutils_build_sp1"
binutils_build_sp1
echo "  gcc_build_sp1"
gcc_build_sp1
echo "  linux_headers_build"
linux_headers_build
echo "  glibc_build"
glibc_build
echo "  libstdc_build"
libstdc_build
echo "  binutils_build_sp2"
binutils_build_sp2
echo "  gcc_build_sp2"
gcc_build_sp2
echo "  m4_build"
...
echo "  bzip2_build"
bzip2_build
echo "  coreutils_build"
coreutils_build
echo "  diffutils_build"
diffutils_build
echo "  file_build"
file_build
...
echo "  texinfo_build"
texinfo_build
echo "  util_linux_build"
util_linux_build
echo "  xz_build"
xz_build
echo "  lzip_build"
lzip_build
echo "  tar_slack_build"
tar_slack_build
echo "  which_build"
which_build
echo "  strip_libs"
